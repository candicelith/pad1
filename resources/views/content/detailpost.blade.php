    ...
    <section class="mt-20 bg-white sm:mt-28">
        <div class="mx-auto max-w-screen-xl py-8 lg:px-6 lg:py-16">
            <div class="flex w-full flex-row items-start justify-center">
                ...
                <!-- Back Button -->
                <button onclick="history.back()" class="lg:mb-0 lg:me-16">
                    ...
                    <div
                        ...
                        <div class="flex flex-col lg:flex-row lg:space-x-8">
                            ...
                            <div class="mt-4 lg:mt-0">
                                <!-- Company Name -->
                                <h2 class="mb-2 text-2xl tracking-tight text-cyan">BCA</h2>
                                <!-- Position -->
                                <h2 class="mb-2 text-xl tracking-tight text-cyan">UI/UX</h2>
                                <!-- Posted By "Name" -->
                            ...
                            <div
                                ...
                                <div class="relative rounded-lg bg-cyan-100 shadow">
                                    <div class="p-4 text-center md:p-5">
                                        ...
                                        <button data-modal-hide="defaultModal" type="button" {{-- onclick="navigateToHome()" --}}
