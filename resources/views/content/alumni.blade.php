...
@section('content')
    ...
    <script>
        function searchAlumni(event) {
            ...
            const searchTerm = document.getElementById('simple-search').value.toLowerCase(); // Get search term
            const alumniCards = document.querySelectorAll('.alumni-card'); // Select all alumni cards

            alumniCards.forEach(card => {
                const name = card.getAttribute('data-name').toLowerCase(); // Get alumni name from card
