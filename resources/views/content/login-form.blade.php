    ...
    <section class="mt-28 bg-white sm:mt-0">
                    ...
                    <form id="registration-form" action="{{ route('registration.submit') }}" method="POST">
                        ...
                        <div class="mt-5 w-full" id="step-1">
                            <ol class="mb-4 flex w-full items-center space-x-2 sm:mb-5">
                                <li class="flex w-full items-center after:inline-block after:h-1 after:w-full after:rounded-full after:border-4 after:border-b after:border-blue-600 after:content-['']"></li>
                                <li class="flex w-full items-center after:inline-block after:h-1 after:w-full after:rounded-full after:border-4 after:border-b after:border-gray-400 after:content-['']"></li>
                            </ol>
                            ...
                            <div class="flex justify-between space-x-4">
                                <button type="button" class="bg-btn-cyan-100 w-1/2 rounded-lg border border-gray-400 bg-gray-300 px-14 py-2 text-center text-xl font-medium text-gray-500" disabled>
                                    Previous
                                </button>
                                <button type="button" id="next-btn" class="bg-btn-cyan w-1/2 rounded-lg bg-cyan px-20 py-2 text-center text-xl font-medium text-white hover:bg-cyan-400">
                                    Next
                                </button>
                            </div>
                        </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                // Prefill data from session if available
                @if(session('name'))
