...
@section('content')
    <!-- Hero Carousel Start -->
    <section id="default-carousel" class="relative w-full mt-20" data-carousel="slide">
        <!-- Carousel wrapper -->
        <div class="relative h-screen overflow-hidden">
            ...
            <div class="absolute inset-0 transform translate-x-0 transition-transform duration-700 ease-in-out"
                data-carousel-item>
                <div
                    class="bg-center bg-no-repeat bg-jumbotron-2 shadow bg-gray-700 bg-blend-multiply h-full flex items-center justify-start px-4 text-start py-20 md:py-24 lg:py-56 w-full">
                    <div class="text-white w-full max-w-screen-xl mx-auto">
                        <h1 class="mb-4 text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-tight">
                            Adaptasi dan Skill Baru: Tantangan Dunia Kerja di Era Digital
                        </h1>
                        <p class="mb-8 text-base sm:text-lg lg:text-xl font-normal text-gray-300">
                            Era digital membawa perubahan besar dalam dunia kerja. Kemajuan teknologi mengharuskan para profesional untuk terus beradaptasi dengan berbagai skill baru yang dibutuhkan oleh industri.
                            Dari kemampuan analisis data hingga keahlian dalam menggunakan alat kolaborasi...
                        </p>
                        <a href="#"
                            class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-white bg-cyan-100 rounded-lg hover:bg-white hover:text-cyan-100 focus:ring-4 focus:ring-cyan">
                            Read More
            ...
            <!-- Slide 3 -->
            <div class="absolute inset-0 transform translate-x-1 transition-transform duration-700 ease-in-out" data-carousel-item>
                <div
                    class="bg-center bg-no-repeat bg-jumbotron-3 shadow bg-gray-700 bg-blend-multiply h-full flex items-center justify-start px-4 text-start py-20 md:py-24 lg:py-56 w-full">
                    <div class="text-white w-full max-w-screen-xl mx-auto">
                        <h1 class="mb-4 text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-tight">
                            Tips & Trik Karir: Panduan Memasuki Dunia Kerja bagi Fresh Graduate
                        </h1>
                        <p class="mb-8 text-base sm:text-lg lg:text-xl font-normal text-gray-300">
                            Memasuki dunia kerja sebagai fresh graduate bisa menjadi tantangan tersendiri.
                            Selain persaingan yang ketat, lulusan baru juga perlu memahami etika profesional dan cara beradaptasi di lingkungan kerja yang dinamis. ...                        </p>
                        <a href="#"
                            class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-white bg-cyan-100 rounded-lg hover:bg-white hover:text-cyan-100 focus:ring-4 focus:ring-cyan">
                            Read More
                        </a>
    ...
    <section class="px-4 mx-auto max-w-screen-xl py-10">
        <div class="flex flex-col lg:flex-row lg:space-x-8">
            ...
            <div class="w-full lg:w-3/4 bg-cyan-100 rounded-lg p-6">
                <h1 class="text-xl sm:text-2xl mb-3 text-white">Posts</h1>
                @foreach ($posts as $ps)
                    <div class="mb-4 cursor-pointer" onclick="navigateToDetailPost()">
                        <article class="p-6 pb-0 bg-lightblue rounded-lg border border-gray-500 shadow-lg">
                            ...
                            <div class="flex flex-col sm:flex-row sm:space-x-4 mb-2">
                                <div class="w-16 h-16">
                                    <img class="w-full h-full rounded-full object-cover" src="{{ $ps->profile_photo }}" alt="Profile Photo" />
                                </div>
                                <div class="mt-2">
                            ...
                            <div>
                                <p class="text-xs sm:text-base my-6">{{ $ps->vacancy_description }}</p>
                                <img class="w-full h-32 md:h-40 rounded-tr-md rounded-tl-md object-cover" src="{{ $ps->vacancy_picture }}" alt="Vacancy Picture" />
                            </div>
                        </article>
                    </div>
                @endforeach
                <a href="{{ route('posts') }}" class="mt-10 inline-flex justify-center items-center py-2 px-4 text-cyan bg-white rounded-lg hover:bg-cyan hover:text-white">
                    More
                </a>
            </div>
            <!-- End Posts Section -->
            ...
            <div class="w-full lg:w-1/4 bg-cyan-100 rounded-lg p-6 mt-6 lg:mt-0 flex flex-col justify-between h-full">
                <h1 class="text-xl mb-4 text-white">Top 10 Companies Alumni Work For</h1>
                <div class="flex flex-col flex-grow">
                    @foreach ($company as $com)
                        <div class="mb-8 flex-grow-0">
                            <article class="p-4 py-5 bg-lightblue rounded-lg border border-gray-500 shadow-lg">
                                <div class="flex flex-col sm:flex-row sm:space-x-4">
                                    ...
                                    <div class="mt-2 sm:mt-0">
                                        ...
                                        <div class="flex items-center mt-2 space-x-0.5 sm:space-x-1">
                                            <span class="text-sm sm:text-lg">{{ $com->employee_count }}</span>
