...
<body>
    ...
    <footer class="p-4 bg-cyan md:p-8 lg:p-10">
        <div class="mx-auto max-w-screen-xl text-center">
            ...
            <p class="my-6 text-gray-500">Website for Software Engineering Techology student searching alumni's information.</p>
            <span class="text-sm text-gray-500 sm:text-center">© 2024. <a href="#" class="hover:underline">Developed by Naila, Naufal, Irene, and Fagan. All right reserved</a>. All Rights Reserved.</span>
        </div>
      </footer>
    <!-- Footer End -->
