    ...
    <section class="flex min-h-screen items-center justify-center bg-white">
        <div class="mx-auto max-w-screen-xl px-4 py-8 lg:px-6 lg:py-16">
            <div class="mx-auto max-w-screen-lg text-center">
                ...
                <p class="mb-9 text-5xl tracking-tight text-gray-900">HTTP Version Not Supported</p>
                <p class="mb-9 text-lg font-light text-gray-500">Sorry, the server is unable to support the current
                    version of your request.</p>
